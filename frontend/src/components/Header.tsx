      ...
      <header className="sticky-top shadow-sm">
              ...
              <ul className="navbar-nav mx-auto mb-2 mb-md-0">
                ...
                <li className="nav-item dropdown px-2">
                  ...
                  <ul className="dropdown-menu">
                    <li><Link className="dropdown-item" to="/rooms/living-room">PHÒNG KHÁCH</Link></li>
                    <li><Link className="dropdown-item" to="/rooms/kitchen">PHÒNG BẾP</Link></li>
                    <li><Link className="dropdown-item" to="/rooms/bedroom">PHÒNG NGỦ</Link></li>
                    <li><Link className="dropdown-item" to="/rooms/bathroom">PHÒNG TẮM</Link></li>
                    <li><Link className="dropdown-item" to="/rooms/workspace">PHÒNG LÀM VIỆC</Link></li>
                    <li><Link className="dropdown-item" to="/rooms/kids-room">PHÒNG TRẺ EM</Link></li>
                  </ul>
                </li>
        ...
        <div className="d-md-none w-100 bg-white px-2">
          ...
          <div className="d-flex justify-content-around align-items-center mb-2">
            <Link to="/store-map" className="text-muted"><i className="bi bi-geo-alt fs-5"></i></Link>
            <Link to="/favorites" className="text-muted position-relative">
            ...
            {user ? (
              <>
                <Link to="/userorder" className="text-dark text-decoration-none">{user.name}</Link>
