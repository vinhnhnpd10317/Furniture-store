...
> = {
  "can-ho-trieu-do-1": {
    ...
    image:
      "../../public/img/img-design/design11.jpg",
    content: (
      <div className="row mt-5">
        ...
        <div className="col-md-6">
          <img
            src="../../public/img/img-design/design12.jpg"
  ...
  "can-ho-trieu-do-2": {
    ...
    image:
      "../../public/img/img-design/design12.jpg",
    content: (
      <div className="row mt-5">
<div className="col-md-6">
        ...
        <div className="col-md-6">
          <img
            src="../../public/img/img-design/design13.jpg"
  ...
  "can-ho-the-cove": {
    ...
    image:
      "../../public/img/img-design/design14.jpg",
    content: (
      <div className="row mt-5">
        <div className="col-md-6">
        ...
        <div className="col-md-6">
          <img
            src="../../public/img/img-design/design16.jpg"
            alt="Phòng khách tối giản"
className="img-fluid rounded mb-3"
          />
          <img
            src="../../public/img/img-design/design17.jpg"
  ...
  "the-collection": {
    ...
    image:
      "../../public/img/img-design/design18.jpg",
    content: (
      <div className="row mt-5">
        <div className="col-md-6">
        ...
        <div className="col-md-6">
          <img
            src="../../public/img/img-design/design19.jpg"
            alt="Phòng ngủ căn hộ 1PN"
            className="img-fluid rounded mb-3"
          />
          <img
            src="../../public/img/img-design/design20.jpg"
