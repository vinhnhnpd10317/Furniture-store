...
export default function BedRoom() {
    // Khi vào trang, sẽ tự cuộn về đầu
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
        ...
        <div className="container-fluid px-0">
            ...
            <div className="container py-4">
                ...
                <h1 className="text-uppercase text-success mb-3">
                    Phòng Ngủ Hiện Đại – Không Gian Sống Đẳng Cấp
                </h1>

                <div className="row g-4">
                    <div className="col-md-4 shadow">
                        <img
                            src="/img/img-room/img-bed-room/h1.jpg"
                            alt="phongngu1"
                            className="img-fluid w-100"
                            style={imageStyle}
                        />
                        <h5 className="text-center text-uppercase fw-semibold text-success mt-3">
                            Chốn Bình Yên Mang Hơi Thở Cổ Điển
                        </h5>
                    ...
                    <div className="col-md-4 shadow">
                        <img
                            src="/img/img-room/img-bed-room/h3.avif"
                            alt="phongngu2"
                            className="img-fluid w-100"
                            style={imageStyle}
                        />
                        <h5 className="text-center text-uppercase fw-semibold text-success mt-3">
                            Không Gian Xanh – Chạm Vào Hơi Thở Rừng Sâu
                        </h5>
                        <p className="text-success fw-light" style={{ textAlign: "justify" }}>
                    ...
                    <div className="col-md-4 shadow">
                        <img
                            src="/img/img-room/img-bed-room/h2.avif"
                            alt="phongngu3"
                            className="img-fluid w-100"
                            style={imageStyle}
                        />
                        <h5 className="text-center text-uppercase fw-semibold text-success mt-3">
                            Phòng Ngủ Retro – Nơi Cất Giữ Ký Ức
                        </h5>
                        <p className="text-success fw-light" style={{ textAlign: "justify" }}>
                    ...
                    <div className="col-md-6 shadow">
                        <img
                            src="/img/img-room/img-bed-room/h4.avif"
                            alt="phongngu4"
                            className="img-fluid w-100"
                            style={imageStyle}
                        />
                    ...
                    <div className="col-md-6 shadow">
                        <img
                            src="/img/img-room/img-bed-room/h5.avif"
                            alt="phongngu5"
                            className="img-fluid w-100"
                            style={imageStyle}
                        />
                    ...
                    <div className="col-md-12 shadow-sm">
                        <img
                            src="/img/img-room/img-bed-room/h6.avif"
                            alt="bo-suu-tap"
                            className="img-fluid w-100"
